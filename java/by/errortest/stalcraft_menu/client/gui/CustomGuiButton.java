...
public class CustomGuiButton extends GuiButton {
    ...
    void playHover(boolean flag) {
        if (flag) {
            ISound mainmenu_hover_sound = PositionedSoundRecord.func_147673_a(new ResourceLocation(Main.MODID, "main_menu_hover"));
            Minecraft.getMinecraft().getSoundHandler().playSound(mainmenu_hover_sound);
        }
    }
}
